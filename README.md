...
#### Unfortunately OpenAPI is no longer free and requires a purchase. This means that in order to use this, you'd need to purchase your own resources via OpenAPI that'll align with your own API Key. It is relatively cheap and if you plan to use this once, you need not spend more than $1. Please ensure you place your API key in the proper location under ./MurderMystery/Game/script.js
